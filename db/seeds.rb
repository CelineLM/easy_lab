...
creatinine = Analysis.new(name: "Créatinine", description: "La créatinine est un composé azoté indispensable à la production d’énergie par les muscles. Il est transporté par le sang, filtré par les reins, puis éliminé par les urines. Les valeurs donnent des indications sur la fonction rénale et sur la masse musculaire. Cette estimation est affinée par le DFG ( débit de filtration glomérulaire), le volume de liquide filtré par le rein .", min_value: 6.0, max_value: 12.0, category: biochimie_du_sang, unit: "mg/l")
creatinine.save!

uree = Analysis.new(name: "Urée", description: "L’urée est une substance éliminée dans les urines et qui provient de la dégradation des protéines des muscles et de l’alimentation. On la retrouve dans le sang et dans les urines. La mesure de l’urée sanguine permet d’estimer en partie le fonctionnement des reins, mais cette mesure est moins précise que celle de la créatinine. Elle est donc assez rarement prescrite désormais.", min_value: 0.15, max_value: 0.40, category: biochimie_du_sang, unit: "g/l")
uree.save!
...
b1 = Analysis.new(name: "Vitamine B1", description: "La vitamine B1 (Thiamine) est essentielle pour transformer les glucides en énergie dans l'organisme. Elle ne peut pas être synthétisée par le corps humain, il est donc primordial de l'apporter par l'alimentation. Cette vitamine a des interactions dans le corps avec les vitamines B2, B3, B5, B6 et B9.", min_value: 66.5, max_value: 200.0, category: vitamines, unit: "nmol/l")
b1.save!

b2 = Analysis.new(name: "Vitamine B2", description: "La vitamine B2 (riboflavine) est aussi appelée vitamine du tonus car elle est essentielle à la production d'énergie grâce à la dégradation des protéines, des lipides et des glucides.Essentielle pour la croissance des tissus (peau et yeux en particulier), la vitamine B2 participe au processus de production d'énergie des cellules et sert à la fabrication des globules rouges et des hormones. Cette vitamines est fabriquée par l’organisme (au niveau de la flore intestinale) mais en quantité insuffisante pour satisfaire les besoins de l’organisme. ", min_value: 75.0, max_value: 150.0, category: vitamines, unit: "µg/l")
b2.save!

e = Analysis.new(name: "Vitamine E", description: "La vitamine E est une vitamine recouvrant un ensemble de huit molécules organiques.La principale vertu de la vitamine E est son action antioxydante qui lui permet de lutter contre le stress oxydatif et de contrer les effets délétères des radicaux libres. Elle agit ainsi en synergie avec d'autres antioxydants reconnus : la vitamine C, le sélénium et le bêta-carotène.", min_value: 3.0, max_value: 12.0, category: vitamines, unit: "mg/l")
e.save!

c = Analysis.new(name: "Vitamine C", description: "La vitamine C (acide asorbique) est un puissant antioxydant qui permet de lutter contre le stress oxydatif, en préservant les cellules des radicaux libres et donc du vieillissement prématuré. La vitamine C est naturellement présente dans un certain nombre de fruits et légumes. Elle permet surtout de lutter contre l'oxydation et de renforcer notre système immunitaire. Cependant, notre organisme ne sait ni la synthétiser, ni la stocker. Il est donc primordial d'en absorber régulièrement pour rester en bonne santé. ", min_value: 5.0, max_value: 17.0, category: vitamines, unit: "mg/l")
c.save!

b6 = Analysis.new(name: "Vitamine B6", description: "La vitamine B6 joue un rôle de cofacteur dans un grand nombre de processus reliés au métabolisme des acides aminés et des protéines. Elle joue un rôle crucial dans la synthèse de certains anticorps, de l'hémoglobine et de certains neurotransmetteurs comme la sérotonine, la mélatonine, la dopamine et l'acide gamma-aminobutyrique. Elle joue, à ce titre, un rôle important dans le maintien de l’équilibre psychique. Elle contribue à la bonne absorption de la vitamine B12 par l'organisme et à la production d'acide chlorhydrique. La vitamine B6 est aussi nécessaire à la production de la vitamine B3 ou niacine, à partir du tryptophane, un acide aminé. Et, comme la majorité des vitamines du groupe B, la vitamine B6 est essentielle à la production d’énergie à partir du glycogène musculaire (forme de stockage des sucres dans le muscle).", min_value: 5.0, max_value: 30.0, category: vitamines, unit: "ng/ml")
b6.save!

b12 = Analysis.new(name: "Vitamine B12", description: "La vitamine B12 est essentielle au bon renouvellement cellulaire et à la fabrication des globules rouges. Elle est aussi très importante chez les femmes enceintes pour le bon développement du fœtus. Description de la vitamine B12 : La vitamine B12 ou cobalamine, compte parmi les vitamines hydrosolubles (solubles dans l’eau). Elle doit son nom à l’atome de cobalt qu’elle renferme dans sa structure. Rôles dans l’organisme : La vitamine B12 est indispensable au renouvellement cellulaire. Elle contribue ainsi au bon état de la peau. Elle participe à la formation des globules rouges. Elle est essentielle au bon fonctionnement des neurones (cellules nerveuses). En association avec la vitamine B9, elle permet de réduire le taux sanguin d’ homocystéine, un composé dont l’excès est impliqué dans les maladies cardiovasculaires. Chez la femme, durant une grossesse, la vitamine B12 est importante pour l’expansion du volume sanguin, tout comme le développement du système nerveux du fœtus1.", min_value: 187.0, max_value: 883.0, category: vitamines, unit: "pg/ml")
b12.save!

d = Analysis.new(name: "Vitamine D", description: "La vitamine D intervient dans le l'absorption du calcium et du phosphore. Elle joue un rôle essentiel dans la minéralisation des os. Pour être utilisable par l'organisme, la vitamine D a besoin de l'action des rayons ultraviolets du soleil. Découvrez le rôle de cette vitamine, ses apports nutritionnels recommandés, les risques de carences ou de surdosage ainsi que ses applications médicales. Qu'est-ce que la vitamine D ? La vitamine D, ou calciférol, compte parmi les vitamines liposolubles (solubles dans les graisses). Elle a deux origines : L’alimentation ; Et une production par la peau exposée aux rayons solaires. Les personnes qui vivent dans des régions peu ensoleillées ou qui sortent peu (personnes âgées) doivent tout particulièrement veiller à leurs apports d’origine alimentaire. Rôles dans l’organisme : Pour être active, la vitamine D doit être transformée en 1,25 dihydroxyvitamine D ou calcitriol, après passage dans le foie et le rein. Elle est connue depuis longtemps pour son effet protecteur du tissu osseux à tout âge : chez l’enfant, elle est indispensable à la croissance osseuse (dite anti-rachitisme) et chez le sénior, elle contribue à la prévention de l’ ostéoporose. Elle agit notamment en augmentant l’assimilation intestinale du calcium et sa fixation sur le squelette, accroissant ou au moins préservant la densité minérale osseuse1 ; De récents travaux ont démontré qu’elle est aussi essentielle au bon fonctionnement musculaire, favorisant la contraction ainsi que le renouvellement des fibres musculaires ; Elle apparaît protectrice des neurones, participant à la prévention du déclin des facultés intellectuelles avec l’avancée en âge ; En améliorant la sensibilité à l’insuline (et ainsi en diminuant les phénomènes inflammatoires et le risque d’ hypertension artérielle), elle pourrait contribuer à la prévention des maladies cardiovasculaires ; Modulant le fonctionnement du système immunitaire, son rôle est envisagé (mais non démontré) dans la protection contre certains cancers et certaines maladies auto-immunes (des maladies au cours desquelles l’organisme produit des anticorps contre ses propres tissus), telles que le diabète de type 1 ou la polyarthrite rhumatoïde2.", min_value: 30.0, max_value: 60.0, category: vitamines, unit: "ng/ml")
d.save!

b9 = Analysis.new(name: "Vitamine B9 (Acide folique)", description: "Définition, fonctions et rôles de la vitamine B9. L'acide folique ou la vitamine B9 a un rôle essentiel dans la production du matériel génétique (ADN, ARN) et des acides aminés nécessaires à la croissance cellulaire ce qui explique son caractère indispensable aux cours des différentes phases de la vie. Elle a un rôle important dans la formation des globules rouges, le fonctionnement du système nerveux (synthèse de neuromédiateurs) et du système immunitaire. Elle est nécessaire à la production de nouvelles cellules, ce qui la rend particulièrement importante durant les périodes d’activité métabolique intense comme l'enfance, l'adolescence, la grossesse (développement du fœtus). En France, l’incidence moyenne des anomalies de fermeture du tube neural (AFTN), une conséquence majeure de cette carence chez la femme en tout début de grossesse, est d’environ 1 grossesse sur 1000. Composition des aliments en vitamine B9 et sensibilité de la vitamine : Les aliments naturellement les plus riches en vitamine B9 sont les foies, la levure alimentaire, le jaune d’œuf, l’échalote, les légumes à feuilles vertes et les escalopes végétales à base de soja.", min_value: 3.1, max_value: 20.5, category: vitamines, unit: "ng/ml")
b9.save!

# serologie

syphilis = Analysis.new(name: "Syphilis", description: "La syphilis est une infection sexuellement transmissible due à une bactérie : le tréponème pâle. En l’absence de traitement précoce, cette maladie devient chronique et le risque de transmission augmente. Très contagieuse, elle touche surtout les hommes ayant des rapports sexuels avec les hommes. La syphilis est une infection sexuellement transmissible (IST) très contagieuse. Elle est due à une bactérie de type spirochète appelée treponema pallidum, ou tréponème pâle. En l’absence de traitement précoce, la syphilis évolue par phases, peut progresser vers une maladie chronique, expose le malade à des complications et est transmise à d’autres partenaires sexuels. À tous ses stades d’évolution, même tardifs, la syphilis est traitée par antibiotiques, permettant la guérison du patient.", min_value: 0.0, max_value: 0.99, category: serologie, unit: "UA")
syphilis.save!
